...
#include "FreeWordView.h"

#ifdef _DEBUG
#define new DEBUG_NEW
#endif

// CFreeWordView message handlers
//
...
IMPLEMENT_DYNCREATE(CFreeWordView, CView)

BEGIN_MESSAGE_MAP(CFreeWordView, CView)
    ON_WM_SETFOCUS()
    ON_WM_KILLFOCUS()
    ON_WM_CHAR()
    ON_WM_KEYDOWN()
...
CFreeWordView::CFreeWordView() noexcept
    : m_nCaretX(0)
    , m_nCaretY(0)
    , m_nLineHeight(16)
    , m_nCharWidth(8)
...
CFreeWordView::~CFreeWordView()
{
}

BOOL CFreeWordView::PreCreateWindow(CREATESTRUCT& cs)
{
...
void CFreeWordView::OnInitialUpdate()
{
...
void CFreeWordView::RecalcMetrics(CDC* pDC)
{
...
void CFreeWordView::OnDraw(CDC* pDC)
{
    CFont* pOldFont = pDC->SelectObject(&m_font);
...
void CFreeWordView::UpdateCaretPos()
{
    SetCaretPos(CPoint(m_nCaretX * m_nCharWidth, m_nCaretY * m_nLineHeight));
}

void CFreeWordView::OnSetFocus(CWnd* pOldWnd)
{
...
void CFreeWordView::OnKillFocus(CWnd* pNewWnd)
{
...
void CFreeWordView::OnSize(UINT nType, int cx, int cy)
{
...
void CFreeWordView::OnChar(UINT nChar, UINT nRepCnt, UINT nFlags)
{
...
void CFreeWordView::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags)
{
    switch (nChar)
    {
    case VK_RETURN:
...
#ifdef _DEBUG
CFeeWordDoc* CFreeWordView::GetDocument() const
{
